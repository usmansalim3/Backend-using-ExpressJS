...
var _reactNativeVirtualizedView = require("react-native-virtualized-view");
...
const AutoCompleteComponent = props => {
  ...
  const [values, setValues] = (0, _react.useState)(null);
  ...
  const _renderItem = _ref => {
    ...
    }, renderItem ? renderItem(item) : /*#__PURE__*/_react.default.createElement(_reactNative.View, {
  ...
  const _renderItemSelected = () => {
    if (values && values.length > 0) {
      return /*#__PURE__*/_react.default.createElement(_reactNativeVirtualizedView.ScrollView, {
        keyboardShouldPersistTaps: "handled"
      }, /*#__PURE__*/_react.default.createElement(_reactNative.View, {
        style: _styles.styles.listContainer
...
var _default = AutoCompleteComponent;
